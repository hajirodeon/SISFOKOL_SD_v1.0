...
$pegawai_session = $_SESSION['pegawai_session'];
...
if (($kd_session == "") AND ($nip_session == "") AND ($pegawai_session == "") AND ($username_session == "") AND ($password_session == "") AND ($hajirobe_session == ""))
	{
