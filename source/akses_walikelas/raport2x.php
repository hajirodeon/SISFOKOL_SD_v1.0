...
//cek, sudah ada belum?
$SQLcek = sprintf("SELECT * FROM siswa_raport_ekstra ".
					"WHERE kd_tapel = '$row_rstapel[kd]' ".
					"AND kd_semester = '$row_rssmt[kd]' ".
					"AND kd_kelas = '$mkkd' ".
					"AND kd_ruang = '$mrkd' ".
					"AND kd_ekstra = '$ekstrakd' ".
					"AND kd_siswa = '$kd'");
...
if ($totalRows_rscek != 0) 
	{
	//update aja
	$SQLupdate = sprintf("UPDATE siswa_raport_ekstra SET kd_nilai = '$angkakd' ".
							"WHERE kd_tapel = '$row_rstapel[kd]' ".
							"AND kd_semester = '$row_rssmt[kd]' ".
							"AND kd_kelas = '$mkkd' ".
							"AND kd_ruang = '$mrkd' ".
	...
	{
	$SQL = sprintf("INSERT INTO siswa_raport_ekstra(kd, kd_siswa, kd_tapel, kd_semester, ".
					"kd_kelas, kd_ruang, kd_ekstra, kd_nilai) ".
					"VALUES ('$x', '$kd', '$row_rstapel[kd]', '$row_rssmt[kd]', ".
					"'$mkkd', '$mrkd', '$ekstrakd', '$angkakd')");
