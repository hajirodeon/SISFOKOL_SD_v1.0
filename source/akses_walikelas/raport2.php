...
if ($totalRows_rscek != 0) 
	...
	{
	$SQL = sprintf("INSERT INTO siswa_raport(kd, kd_siswa, kd_tapel, kd_semester, ".
					"kd_kelas, kd_ruang, kd_pelajaran, kd_nilai) ".
					"VALUES ('$x', '$kd', '$row_rstapel[kd]', '$row_rssmt[kd]', ".
					"'$mkkd', '$mrkd', '$pelkd', '$angkakd')");
