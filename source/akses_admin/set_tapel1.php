...
//ambil nilai
$tapeli = cegah($_POST['tapel']);

//netralkan dahulu. . .
$SQL1 = sprintf("UPDATE m_tapel SET status = 'false'");

mysql_select_db($database_sisfokol, $sisfokol);
$Rs1 = mysql_query($SQL1, $sisfokol) or die(mysql_error());

//set tahun pelajaran sekarang!
$SQL2 = sprintf("UPDATE m_tapel SET status = 'true' WHERE kd = '$tapeli'");
