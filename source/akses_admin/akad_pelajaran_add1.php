...
//cek, sudah ada belum
$SQL1 = sprintf("SELECT * FROM m_pelajaran ".
					"WHERE kd_kelas = '$kelas' ".
					"AND pelajaran = '$pelajaran'");
...
if ($totalRows_rs1 != 0) 
	{
	$pesan = "Pelajaran sudah ada, Silahkan diulangi!";
	$kembali = "akad_pelajaran.php";
...
//perintah SQL
$SQL2 = sprintf("INSERT INTO m_pelajaran(kd, kd_kelas, pelajaran) ".
					"VALUES ('$x', '$kelas', '$pelajaran')");
...
$returner = "akad_pelajaran.php?kelkod=$kelkod";
