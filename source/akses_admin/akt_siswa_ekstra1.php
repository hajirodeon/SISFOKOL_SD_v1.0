...
//ambil nilai
$kd = cegah($_REQUEST['mskd']);
$ekstra = cegah($_REQUEST['ekstra']);


//cek, sudah ada belum
$SQL1 = sprintf("SELECT * FROM siswa_ekstra WHERE kd_ekstra = '$ekstra'");
...
if ($totalRows_rs1 != 0) 
	{
	$pesan = "Ekstrakurikuler sudah diambil. Ganti yang lain";
	$returner = "akt_siswa_ekstra_detail.php?kd=$mskd&nama=$nama";
...
//perintah SQL
$SQL2 = sprintf("INSERT INTO siswa_ekstra(kd_siswa, kd_ekstra) ".
					"VALUES ('$kd', '$ekstra')");
