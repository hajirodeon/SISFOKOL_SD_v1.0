...
if ($filex_type != 'image/pjpeg')
	...
	$kembali = "kepg_pegawai_detail.php";
...
//mengkopi file
copy($filex,"../filebox/pegawai/$kd/foto/$filex_name"); 

//perintah SQL
$SQL2 = sprintf("UPDATE m_pegawai SET foto = '$filex_name' WHERE kd = '$kd'");
...
//auto-kembali
$returner = "kepg_pegawai_detail.php?kd=$kd";
