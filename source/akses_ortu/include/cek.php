...
$ortusiswa_session = $_SESSION['ortusiswa_session'];
...
if (($kd_session == "") AND ($nis_session == "") AND ($ortusiswa_session == "") AND ($username_session == "") AND ($password_session == "") AND ($hajirobe_session == ""))
	{
